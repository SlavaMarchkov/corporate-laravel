...
<![endif]-->
    ...
    <!-- START BODY -->
    <body class="no_js responsive {{ (Route::currentRouteName() == 'home' || Route::currentRouteName() == 'portfolios.index' || Route::currentRouteName() == 'portfolios.show' || Route::currentRouteName() == 'login') ? 'page-template-home-php' : '' }} stretched">
                ...
                <div id="header" class="group">
                    ...
                    <div class="group inner">
                        ...
                        <div id="logo" class="group">
                            <a href="{{ route('home') }}" title="Pink Rio"><img src="images/logo.png" title="Pink Rio" alt="Pink Rio" /></a>
                        </div>
                        <!-- END LOGO -->
